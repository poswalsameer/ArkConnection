...
function QuizReport() {
  ...
  return (
    ...
    <div className="min-h-screen w-[100%] flex flex-col justify-center items-center bg-bodyBackground">
        ...
        <Button className="h-12 w-36 bg-[#344e41] hover:bg-[#3d5c4c] rounded-full text-[#e6ccb2] text-base font-bold" 
