    ...
    <>
      ...
      >
          ...
          2xl:mr-16 2xl:h-96 2xl:w-2/3 2xl:flex 2xl:flex-col 2xl:px-10 2xl:gap-y-10 2xl:justify-center 2xl:items-center ">
            ...
            2xl:text-5xl  2xl:font-bold">Acharya Alok Awasthi</div>
            <div className="
          ...
          2xl:w-full 2xl:flex 2xl:flex-col 2xl:justify-center 2xl:gap-y-5">
              ...
              2xl:ml-10 2xl:text-4xl 2xl:font-bold">Our Mission</div>
              ...
              2xl:text-xl 2xl:ml-10 2xl:font-bold">
                      ...
                      <p>To provide higher lifestyle education in Veda, Upanishad, Astrology, Numerology, Vastu, Meditation, Ayurveda and other traditional subjects.</p>
                      <p>To recognize the students with certification of scholar from Maharishi Kapi with respect to above mentioned subjects.</p>
                      <p>To conduct courses, workshops, lectures & demonstrations in the Vedic and allied Tradition for the help of people across the world.</p>
              </div>
          </div>
          ...
          2xl:mb-20 2xl:w-full 2xl:flex 2xl:flex-col 2xl:justify-center 2xl:gap-y-5">
              ...
              lg:ml-10 lg:text-4xl  lg:font-bold
              xl:ml-10 xl:text-4xl xl:font-bold
              2xl:ml-10 2xl:text-4xl 2xl:font-bold">Our Vision</div>
