...
function Page() {
  return (
    <div
      className="
      min-h-screen w-full flex flex-col justify-center items-center gap-y-20 bg-[#fdf0d5]
      sm:min-h-screen sm:w-full sm:flex sm:flex-col sm:justify-center sm:items-center sm:gap-y-28 sm:bg-[#fdf0d5]
      md:min-h-screen md:w-full md:flex md:flex-col md:justify-center md:items-center md:gap-y-28 md:bg-[#fdf0d5]
      lg:min-h-screen lg:w-full lg:flex lg:flex-col lg:justify-center lg:items-center lg:gap-y-28 lg:bg-[#fdf0d5]
      xl:min-h-screen xl:w-full xl:flex xl:flex-col xl:justify-center xl:items-center xl:gap-y-28 xl:bg-[#fdf0d5]
      2xl:min-h-screen 2xl:w-full 2xl:flex 2xl:flex-col 2xl:justify-center 2xl:items-center 2xl:gap-y-28 2xl:bg-[#fdf0d5] 
    "
    >
        <div className="
        mx-6 h-28 w-[95%] flex justify-center items-center text-center bg-[#ddbea9] text-[#344e41] rounded-full mt-20 text-lg font-bold
        sm:mx-8 sm:h-24 sm:w-[95%] sm:flex sm:justify-center sm:items-center sm:text-center sm:bg-[#ddbea9] sm:text-[#344e41] sm:rounded-full sm:mt-20 sm:text-xl sm:font-bold
        md:mx-6 md:h-24 md:w-[95%] md:flex md:justify-center md:items-center md:text-center md:bg-[#ddbea9] md:text-[#344e41] md:rounded-full md:mt-20 md:text-3xl md:font-bold
        lg:mx-6 lg:h-24 lg:w-[95%] lg:flex lg:justify-center lg:items-center lg:text-center lg:bg-[#ddbea9] lg:text-[#344e41] lg:rounded-full 
        lg:mt-20 lg:text-3xl lg:font-bold
        xl:mx-6 xl:h-20 xl:w-[95%] xl:flex xl:justify-center xl:items-center xl:text-center xl:bg-[#ddbea9] xl:text-[#344e41] xl:rounded-full 
        xl:mt-20 xl:text-4xl xl:font-bold
        2xl:mx-6 2xl:h-20 2xl:w-[95%] 2xl:flex 2xl:justify-center 2xl:items-center 2xl:text-center 2xl:bg-[#ddbea9] 2xl:text-[#344e41] 2xl:rounded-full 
        ...
        <div className="
        mr-0 h-[28rem] w-[80%] flex flex-col px-10 gap-y-10 justify-center items-center bg-[#e4c6b2] rounded-lg
        sm:mr-0 sm:h-96 sm:w-[80%] sm:flex sm:flex-col sm:px-10 sm:gap-y-10 sm:justify-center sm:items-center sm:bg-[#e4c6b2] sm:rounded-lg
        md:mr-0 md:h-96 md:w-[80%] md:flex md:flex-col md:px-10 md:gap-y-10 md:justify-center md:items-center md:bg-[#e4c6b2] md:rounded-lg
        lg:mr-16 lg:h-96 lg:w-2/3 lg:flex lg:flex-col lg:px-10 lg:gap-y-10 lg:justify-center lg:items-center lg:bg-[#e4c6b2] lg:rounded-lg
        xl:mr-16 xl:h-96 xl:w-2/3 xl:flex xl:flex-col xl:px-10 xl:gap-y-10 xl:justify-center xl:items-center xl:bg-[#e4c6b2] xl:rounded-lg
        2xl:mr-16 2xl:h-96 2xl:w-2/3 2xl:flex 2xl:flex-col 2xl:px-10 2xl:gap-y-10 2xl:justify-center 2xl:items-center 2xl:bg-[#e4c6b2] 2xl:rounded-lg">
          <div className="
          text-xl text-[#344e41] font-bold
          sm:text-4xl sm:text-[#344e41] sm:font-bold
          md:text-4xl md:text-[#344e41] md:font-bold
          lg:text-4xl lg:text-[#344e41] lg:font-bold
          xl:text-4xl xl:text-[#344e41] xl:font-bold
          2xl:text-4xl 2xl:text-[#344e41] 2xl:font-bold">Acharya Alok Awasthi</div>
          <div className="
          text-sm text-[#7d604d] text-center font-semibold
          sm:text-xl sm:text-[#7d604d] sm:text-center sm:font-semibold
          md:text-xl md:text-[#7d604d] md:text-center md:font-semibold
          lg:text-xl lg:text-[#7d604d] lg:text-center lg:font-semibold
          xl:text-xl xl:text-[#7d604d] xl:text-center xl:font-semibold
          2xl:text-xl 2xl:text-[#7d604d] 2xl:text-center 2xl:font-semibold">
        ...
        <div className="
        mx-10 text-base text-[#7d604d] font-bold flex flex-col gap-y-4
        sm:mx-10 sm:text-lg sm:text-[#7d604d] sm:font-bold sm:flex sm:flex-col sm:gap-y-4
        md:mx-10 md:text-lg md:text-[#7d604d] md:font-bold md:flex md:flex-col md:gap-y-4
        lg:mx-10 lg:text-lg lg:text-[#7d604d] lg:font-bold lg:flex lg:flex-col lg:gap-y-4
        xl:mx-10 xl:text-lg xl:text-[#7d604d] xl:font-bold xl:flex xl:flex-col xl:gap-y-4
        2xl:mx-10 2xl:text-lg 2xl:text-[#7d604d] 2xl:font-bold 2xl:flex 2xl:flex-col 2xl:gap-y-4">
        ...
        2xl:w-full 2xl:flex 2xl:flex-col 2xl:justify-center 2xl:gap-y-5">
            <div className="
            ml-10 text-2xl  text-[#344e41]  font-bold
            sm:ml-10 sm:text-4xl  sm:text-[#344e41]  sm:font-bold
            md:ml-10 md:text-4xl  md:text-[#344e41]  md:font-bold
            lg:ml-10 lg:text-4xl  lg:text-[#344e41]  lg:font-bold
            xl:ml-10 xl:text-4xl  xl:text-[#344e41]  xl:font-bold
            2xl:ml-10 2xl:text-4xl  2xl:text-[#344e41]  2xl:font-bold">Our Mission</div>

            <div className="
            text-base ml-10 text-[#7d604d] font-bold
            sm:text-xl sm:ml-10 sm:text-[#7d604d] sm:font-bold
            md:text-xl md:ml-10 md:text-[#7d604d] md:font-bold
            lg:text-xl lg:ml-10 lg:text-[#7d604d] lg:font-bold
            xl:text-xl xl:ml-10 xl:text-[#7d604d] xl:font-bold
            2xl:text-xl 2xl:ml-10 2xl:text-[#7d604d] 2xl:font-bold">
        ...
        2xl:mb-20 2xl:w-full 2xl:flex 2xl:flex-col 2xl:justify-center 2xl:gap-y-5">
            ...
            lg:ml-10 lg:text-4xl lg:text-[#344e41]  lg:font-bold
            xl:ml-10 xl:text-4xl xl:text-[#344e41]  xl:font-bold
            2xl:ml-10 2xl:text-4xl 2xl:text-[#344e41]  2xl:font-bold">Our Vision</div>

            <div className="
            text-base mx-10 text-[#7d604d] font-bold
            sm:text-xl sm:mx-10 sm:text-[#7d604d] sm:font-bold
            md:text-xl md:mx-10 md:text-[#7d604d] md:font-bold
            lg:text-xl lg:mx-10 lg:text-[#7d604d] lg:font-bold
            xl:text-xl xl:mx-10 xl:text-[#7d604d] xl:font-bold
            2xl:text-xl 2xl:mx-10 2xl:text-[#7d604d] 2xl:font-bold">
